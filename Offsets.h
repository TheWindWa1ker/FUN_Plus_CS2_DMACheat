...
namespace Offset
{
	...
	inline DWORD SensPointer = cs2_dumper::offsets::client_dll::dwSensitivity;
	inline DWORD Sensitivity = cs2_dumper::offsets::client_dll::dwSensitivity_sensitivity;
	...
	struct
	{
		...
		DWORD flFOVSensitivityAdjust = cs2_dumper::schemas::client_dll::C_BasePlayerPawn::m_flFOVSensitivityAdjust;
	}Entity;
	...
	struct
	{
		DWORD HasDefuser = cs2_dumper::schemas::client_dll::CCSPlayer_ItemServices::m_bHasDefuser;
		DWORD HasHelmet = cs2_dumper::schemas::client_dll::CCSPlayer_ItemServices::m_bHasHelmet;
		DWORD HasHeavyArmor = cs2_dumper::schemas::client_dll::CCSPlayer_ItemServices::m_bHasHeavyArmor;
		DWORD ItemServices = cs2_dumper::schemas::client_dll::C_BasePlayerPawn::m_pItemServices;
	...
	struct
	{
		...
		DWORD AllWeapon = cs2_dumper::schemas::client_dll::CPlayer_WeaponServices::m_hMyWeapons;
